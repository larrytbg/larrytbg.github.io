  ...
  try {
    for (const width of [390, 1440]) {
      ...
      await page.setContent(`<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><style>${baseCss}\n${css}</style></head><body><main class="shell">
        ...
        <a class="directory-card"><ul><li class="is-primary is-daily-highlight" data-daily-highlight="new"><span>01</span><span class="directory-item-title"><span class="daily-highlight-badge">今日新增</span>这是一个用于检查目录排版的较长标题</span><small class="directory-item-date">资料发布：2026-08-23</small></li></ul></a>

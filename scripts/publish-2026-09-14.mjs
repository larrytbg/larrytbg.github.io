...
const dateCn = "2026年9月14日";
const checkedAt = "2026-09-14 07:26（北京时间）";
const version = "35";
...
const mappings = new Map([
  ["daily-20260913-headline-rewriting", { target: "daily/03" }],
  ["finance-20260913-ml-market-forecasting", { target: "finance/03" }],
  ["health-20260913-glp1-opioid-observational", { target: "health/03" }],
  ["papers-20260913-glacier-microbes", { target: "papers/03" }],
  ["financial-literacy-20260913-uganda-inclusion", { target: "financial-literacy/01" }],
]);
...
const columnNames = { daily: "每日资讯", finance: "金融", health: "身体健康", papers: "论文研究", "financial-literacy": "财务学习" };
const accents = { daily: "accent-vermilion", finance: "accent-gold", health: "accent-green", papers: "accent-indigo", "financial-literacy": "accent-teal" };
...
const note = `<p class="today-update-note">9月14日完成5篇真实实质更新：每日资讯、金融、身体健康、论文研究和轮换的财务学习栏目各1篇；TED过去24小时没有核准到官方新演讲，未用旧内容补数。${reviewSentence}。<a href="/audit">查看逐篇审计 →</a></p>`;
...
const scope = { daily: 1, finance: 1, health: 1, papers: 1, ted: 0, "financial-literacy": 1 };
...
const audit = {
  ...
  scope,
  sourceScan: { candidates: 0, readyFromWorker: 0, hold: 0, workerReadyRejected: 0, workerHoldPromoted: 0, controllerExpanded: true, selected: 5, note: "来源扫描任务在严格24小时时窗内未交付候选；总控扩大检索范围并回到5个A级原始出版页核验后采用。" },
  freshness: { within24Hours: 5, currentIssueWithoutExactDay: 0, note: "5篇均来自2026年9月13日发布的原始期刊页面，并在北京时间9月14日更新窗口内核准。" },
  tedScan: { scanned: true, newItems: 0, updated: 0, note: "TED官网候选缺少可核准的日级发布日期，无法证明过去24小时真实新增；未用旧演讲补数。" },
  rotation: { column: "financial-literacy", updated: 1, note: "财务学习轮换栏目用于训练代理指标、短期与长期估计以及个人适用边界的区分。" },
...
const auditPage = `<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><link rel="stylesheet" href="/assets/index-CVB57ELS.css"/><link rel="stylesheet" href="/assets/daily-highlights.css"/><title>9月14日更新审计 · 自学总站</title></head><body><header class="site-header"><div class="shell header-inner"><a href="/" class="brand"><span class="brand-mark">知</span><span>自学总站</span></a><nav class="main-nav"><a href="/">全部专栏</a><a href="/ski-training">滑雪训练</a><a href="/archive">每日归档</a></nav><div class="live-status"><span></span> 2026.09.14 · 每日更新 ${version}</div></div></header><main class="shell audit-page"><header class="directory-header"><p>${dateCn} · 真实更新审计</p><h1>5篇真实实质更新，按新鲜度与质量发布</h1><p>每日资讯、金融、身体健康、论文研究和财务学习各1篇。${reviewSentence}。</p></header><section class="audit-summary"><h2>质量说明</h2><p>5篇均来自9月13日发布的原始期刊页面。全部条目已核对主体、文章类型、数字、事实、因果与边界；TED没有核准到过去24小时真实新增演讲。</p></section><section class="audit-list"><h2>逐篇变更</h2><ul>${rows}</ul></section></main><footer class="site-footer"><div class="shell footer-inner"><p>自学总站 · 长期自学知识库</p><p>${dateCn} · 每日更新 ${version}</p></div></footer></body></html>`;
...
archive = archive.replace(/<article class="archive-entry" data-archive-date="2026-09-14">[\s\S]*?<\/article>/, "");
const archiveEntry = `<article class="archive-entry" data-archive-date="2026-09-14"><div class="archive-date"><strong>2026.09.14</strong><span>每日更新 ${version} · 5篇真实实质更新</span></div><div class="archive-content"><h2>${dateCn}</h2><p>本批按质量优先更新5篇：${reviewSentence}；TED没有合格新增，未用旧稿补数。</p><ul><li><span>更新审计</span><a href="/audit">查看5篇逐条审计 →</a></li></ul></div></article>`;
